...
class Object_detect:
    def __init__(self,camera_x = 162, camera_y = 8,camera_z = 370):

        # 移动角度
        self.move_angles = [
            [-28.39, 45.87, -92.37, -41.3, 2.02, 9.58],  # init the point
            [0, 45.87, -92.37, -41.3, 2.02, 9.58],  # point to grab
        ]
    ...
    def init_robot(self):
        self.mc = MyCobotSocket('192.168.11.20')
    ...
    def deside_move(self, x, y, z, id):
        ...
        time.sleep(1)
        self.mc.send_coords(target_coords, 40, 1)
        time.sleep(2)
