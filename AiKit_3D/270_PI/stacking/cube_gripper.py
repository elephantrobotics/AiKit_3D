...
class Object_detect:
    def __init__(self,camera_x = 150, camera_y = -5, camera_z = 365):

        # 移动角度
        self.move_angles = [
            [-95.44, -17.75, 14.23, 1.14, 80.8, 0],  # init the point
            # [0, -17.75, 14.23, 1.14, 85.8, 0],  # point to grab
            # [-0.52,0,-8,0,80.03,0.26]
            # [-1.4,12.52,-15.65,0.35,80.8,0.52]
            # [-2.28,21.79,-23.9,0.61,86.13,0.26]
